...
export const gridOrderImage = (ProductImage: string) => (
    <div>
        <img
...
export const gridOrderStatus = (StatusBg: string, Status: string) => (
    <button
        type="button"
...
const gridEmployeeProfile = (EmployeeImage: string) => (
...
const customerGridImage = (CustomerImage?: string, CustomerName?: string, CustomerEmail?: string) => (
...
const customerGridStatus = (StatusBg?: string, Status?: string) => (
    <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
        <p id={StatusBg.StatusBg}
            style={{ background: StatusBg.StatusBg }}
