...
import { customerGridImageProps, customerGridStatusProps, gridEmployeeProfileProps, gridOrderImageProps, gridOrderStatusProps } from "./type";
...
export const gridOrderStatus = (StatusBg: gridOrderStatusProps) => (
    <button
        type="button"
        style={{ background: StatusBg.StatusBg }}
...
const gridEmployeeProfile = (EmployeeImage: gridEmployeeProfileProps) => (
    <div className="flex items-center justify-center gap-2">
        <img
            className="rounded-full w-10 h-10 "
            src={EmployeeImage.EmployeeImage}
            alt="employee"
        />
    </div>
);
...
const customerGridImage = (CustomerImage: customerGridImageProps) => (
    <div className="image flex items-center justify-center gap-4">
        <img
            className="rounded-full w-10 h-10"
            src={CustomerImage.CustomerImage}
            alt="employee"
        />
    </div>
);
const customerGridStatus = (StatusBg: customerGridStatusProps) => (
    <div className="flex justify-center items-center absolute -mt-1.5 -ml-2">
        <p
            style={{ background: StatusBg.StatusBg }}
...
export const rangeColorMapping = [
    { label: "1°C to 10°C", start: 1, end: 10 },
